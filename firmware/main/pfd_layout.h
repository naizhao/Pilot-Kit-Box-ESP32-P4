...
#define PFD_BANK_ARC_CY    PFD_CY
/* 半径取 138 而不是保守的 130：弧越大，与俯仰梯度端点的间距越大。
 *
 * ±20° 梯度线端点到圆心的距离是 √(45² + 120²) = 128 px（半宽 45、垂直
 * 偏移 20°×6 px）。弧在 138 处，正好让开 10 px；130 时两者几乎贴在一起。
 * 上限则由状态栏决定：弧顶 = 194 - 138 = 56，距 48 px 的状态栏下沿留 8 px。 */
#define PFD_BANK_ARC_R     138      /* 坡度刻度弧半径                  */
/* 俯仰 1° 对应像素（320 屏为 3）。
 *
