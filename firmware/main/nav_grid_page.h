 ...
 * 为什么要换掉 dock
 * ------------------
 * 原来的横向导航 dock 在 4.3 寸屏（800×480）上排开会溢出：7 个页签 × 94 px
 * ＋分隔 8 ＋动作区 94 = 761 px，而 FAB 两侧留白之后可用宽度只有 720，第 8
 * 项根本进不来，且触摸目标越挤越窄。方案 A/C 两版全屏网格
 * 原型经 2026-08-02 评审，方案 C（4×2 网格 + 底部动作条 + 分页）拍板——
