...
3. GitHub Actions 会运行 `.github/workflows/release-esp32p4-firmware.yml`。
4. CI 使用 ESP-IDF v6.0.1 构建 `firmware/`，然后生成 release assets。
5. CI 会创建或更新 GitHub Release，并部署 GitHub Pages 刷写页面。
