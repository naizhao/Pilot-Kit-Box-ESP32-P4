...
| 链路 | 内置 | 外接 | 射频开关 | 说明 |
|---|---|---|---|---|
| **1090** | 板载 IFA（只复用标准倒F拓扑，不复用41mm尺寸），顶边**偏左** | SMA | ✅ XA17-G4K | V4.0实测定型：铜箔外包络50.0mm/中心线跨度48.5mm；远离C6 WiFi天线 |
| **978** | ❌ 不做 | SMA（或 U.FL 尾线） | ❌ 不上 | 与 1090 仅差 10% 频率会强耦合拉偏；且只有美国 GA 用。**整条通道做选贴变体**，国内版省 ¥30 |
| **GNSS** | 25×25×6.3 有源陶瓷 patch，装外壳**顶边凸包**、朝天，X≈70–95 | SMA | ✅ XA17-G4K | 用户已验证该 patch 信号好；顶边凸包在外壳定稿时落实 |
