...
英文版：[`BOM_PURCHASE.md`](BOM_PURCHASE.md)
...
| ✅已有 | 板载1090天线 | IFA_1090 | ANT_IFA_1090MHz | 1 | ANT1 | PCB 铜箔（无器件） | — | 52.0mm画长/53.5mm外包络已落PCB；待装盒VNA+报文A/B；尺寸依据见已归档的 v3 HFSS 天线研究（内部工程记录）§8；不占BOM |
