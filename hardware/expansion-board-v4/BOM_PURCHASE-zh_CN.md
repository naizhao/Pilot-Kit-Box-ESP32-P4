...
| 🔴必买指定 | 射频-978匹配 | 27nH | L_0402_1005Metric | 1 | L10 | muRata LQW15AN27NH00D（绕线 ±3% SRF3.5G） | C113111 | 备选 Sunltech SCW1005C27NJST C330864（±5% SRF3.5G 库存8872）、APV AHW1005C-27NJTF C6364690（±5% SRF2.48G） |
...
| 🔴必买指定 | 射频-LNA偏置 | 3.32k | R_0402_1005Metric | 1 | R11 | 0402 3.32k ±1% | — | QPL9547 pin1 Vbias；按原厂评估板值，禁止用 0Ω 直连 3V3_RF |
| 🔴必买指定 | 射频-LNA馈电扼流 | 18nH 0402CS-18NXGRW | L_0402_1005Metric | 1 | L1 | Coilcraft 0402CS-18NXGRW 或同等高 SRF 绕线 18nH | — | QPL9547 pin7 漏极馈电；按原厂评估板 18nH，替代料必须核对 1090MHz 时仍为感性 |
...
| 🟡有推荐 | 电源-电容 | 10uF | C_1206_3216Metric | 1 | C72 | 1206 10uF 25V X5R/X7R | — | SY6970 PMID，手册明确要求 10µF；接 9V 侧**耐压必须 25V**，并核对所选料在 9V DC bias 下的有效容值 |
...
| 🟡有推荐 | 电源-电阻 | 5.1k | R_0603_1608Metric | 2 | R7,R8 | 0603 5.1k 1% | — | USB-C CC 下拉(Rd)。**与 CH224K 二选一**：带电源版不贴（CH224K 内部自带 Rd），不带电源版必贴，否则主机不认设备 |
...
| 🟢通用/元件本 | 去耦 | 1uF | C_0402_1005Metric | 2 | C48,C5 | 任意 1uF X5R | — | 用元件本 |
...
| 🟢通用/元件本 | 隔直/旁路 | 100pF | C_0402_1005Metric | 11 | C21,C30,C36,C38,C39,C45…(11) | 任意 100pF（X7R 即可） | — | ✅实算：X7R vs C0G 全路径只差 0.13dB，不值得单买 NP0。可用现有元件本 |
...
| ✅已有 | 主芯片 | AD8313ARMZ | MSOP-8_3x3mm_P0.65mm | 1 | U14 | AD8313ARMZ | — | §7 清单已下单 |
...
| ✅已有 | 板载1090天线 | IFA_1090 | ANT_IFA_1090MHz | 1 | ANT1 | PCB 铜箔（无器件） | — | 52.0mm画长/53.5mm外包络已落PCB；待装盒VNA+报文A/B；见v3/IFA_HFSS_2026-08-24.md §8；不占BOM |
...
| ✅已有 | 跳线 | 0R | R_0603_1608Metric | 3 | R21,R22,R23 | 0603 电阻本 0R | — | 用现有元件本 |
