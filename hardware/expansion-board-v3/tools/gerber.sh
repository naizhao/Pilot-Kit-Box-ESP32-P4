...
echo "  4) 板厚 1.6mm，阻焊颜色随意"
echo "  5) 🔴 表面处理必须 **沉金 ENIG**，不能选喷锡 HASL："
echo "     本板 U8 是 QFN-56 / 0.4mm pitch / 焊盘仅 0.200mm，另有三个 LGA"
echo "     （U4 BNO085、U5 BMP388、U6）。HASL 共面度 ±5~15µm，0.5mm pitch"
echo "     以下就不可用；QFN 的大 EP 还会堆出锡丘把周边引脚顶起来。"
echo "     ⚠️「无铅喷锡」比有铅更差（SAC305 表面张力更高）——别选。"
echo "     判据见 hardware/PCB_STACKUP_IMPEDANCE-zh_CN.md §6"
