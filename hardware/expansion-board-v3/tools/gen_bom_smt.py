...
# ⚠️ 这里曾经是 `SKIP_REF = {"U14"}`，理由写的是"AD8313 只是备用检波位，默认贴
# AD8319(U13)"。那是双检波位时代的设定，而产品决策早就统一到 AD8313 ——
# 结果是**唯一的检波器被排除在贴片 BOM 之外**，板子回来 1090 接收链没有检波器。
# AD8319 支路 2026-09-02 已从设计中删除，U14 必贴。
SKIP_REF = set()
