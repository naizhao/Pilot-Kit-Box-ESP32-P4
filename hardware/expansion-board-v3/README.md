# Expansion Board V3.7 Design (Archived)
...
> V3.7 is the final maintenance design with the GNSS antenna-bias ECO.
...
|---|---|---|
| [`PINMAP.md`](PINMAP.md) | Authoritative pin and net map for the V3.7 design | EN / [中文](PINMAP-zh_CN.md) |
...
> V3.7 是包含 GNSS 有源天线偏置 ECO 的最终维护设计。已经打样的 V3.2
> 仍可用于固件调试与天线研究，但必须按内部返修记录修改 Gate 才能正确给有源天线供电。

| 文档 | 内容 | 语言 |
|---|---|---|
| [`PINMAP.md`](PINMAP.md) | V3.7 设计权威引脚/网络映射 | [EN](PINMAP.md) / 中文 |
